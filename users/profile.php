...
$query=mysqli_query($con,"update users set fullName='$fname',emp_id ='$empid', djoin ='$djoin', designation='$desig',dbirth='$dbirth',contactNo='$contactno',address='$address',State='$state',country='$country',pincode='$pincode' where userEmail='".$_SESSION['login']."'");
if($query)
{
...
<div class="col-sm-4">
<input type="text" name="empid" maxlength="8" required="required" value="<?php echo htmlentities($row['emp_id']);?>" class="form-control">
</div>
<label class="col-sm-2 col-sm-2 control-label">Date of Joining </label>
<div class="col-sm-4">
<input type="text" name="djoin" required="required" value="<?php echo htmlentities($row['djoin']);?>" class="form-control datepicker">
 </div>
</div>
...
<div class="col-sm-4">
<input type="text" name="desig"  required="required" value="<?php echo htmlentities($row['designation']);?>" class="form-control">
</div>
<label class="col-sm-2 col-sm-2 control-label">Date of birth</label>
<div class="col-sm-4">
<input type="text" name="dbirth" required="required" value="<?php echo htmlentities($row['dbirth']);?>" class="form-control datepicker">
 </div>
</div>
