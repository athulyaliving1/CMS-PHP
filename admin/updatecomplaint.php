...
$query1=mysqli_query($con,"select tblcomplaints.*,users.fullName as name,users.userEmail as eml,category.categoryName as catname from tblcomplaints join users on users.id=tblcomplaints.userId join category on category.id=tblcomplaints.category where tblcomplaints.complaintNumber='".$_GET['cid']."'");
