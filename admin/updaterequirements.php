...
$query1=mysqli_query($con,"select requirements.*,users.fullName as name,users.userEmail as eml,category.categoryName as catname from requirements join users on users.id=requirements.userId join category on category.id=requirements.category where requirements.reqNumber='".$_GET['cid']."'");
